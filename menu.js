...
function getDishImage(item) {
  ...
  // 1. Item-specific Tea & Milk Drinks
  ...
  // 9. Dal, Lentils & Rajma/Chole Gravies
  ...
  // 12. Non-Veg Chicken, Mutton, Fish, Meat
  ...
  // 13. Chinese, Pasta, Manchurian, Fries
  ...
  // 15. Default fallback by Veg / Non-Veg
